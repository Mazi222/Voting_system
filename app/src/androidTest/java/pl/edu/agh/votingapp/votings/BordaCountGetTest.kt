...
class BordaCountGetTest {
    private val TAG: String = "BORDA_COUNT_TEST"
    ...
    fun mockData(){
        val voting = Voting(votingId = 1, type = VotingType.MAJORITY_VOTE, endTime = Date(1), votingContent = "Test", isOpen = true)
        val voting2 = Voting(votingId = 2, type = VotingType.MAJORITY_VOTE, endTime = Date(1), votingContent = "Test", isOpen = false)
